          ...
          <Grid item xs={6}>
            <div className="box">
              <div className="left">
                ...
                <FormControl sx={{ width: '350px' , marginTop:"5px" }} variant="outlined"
                onChange={(e)=> setConfirmPassword(e.target.value )}>
                  ...
                  <OutlinedInput
                    ...
                    label="Password"
                  />
                  <p className='passErr'>{confirmPasswordErr ? confirmPasswordErr : passwordMatchErr}</p>
                </FormControl> <br></br>

                <Button onClick={ handleSubmit} style={{width:"350px" , marginTop:"20px" , background:"blue" , color:"white", padding:"9px 0"}}>Sign up</Button>
                <div>
                    <p style={{textAlign:"center" , color:"#03014C"}}>Already have an accounyt? <span><Link to={'/login'}>Sign in</Link></span></p>
                </div>
